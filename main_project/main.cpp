...
void testCircuit(stringstream& buffer){
    ...
    // buffer << "V1 N1 0 PWL(0 10 .1 10 .101 0)" <<endl;
    buffer << "V1 001 0 10" <<endl;
    buffer << "R1 002 001 100" <<endl;
    buffer << "C1 002 0 0.0002" <<endl;
    buffer << "L1 002 0 20" <<endl;
    buffer << "R2 002 0 1k" <<endl;
